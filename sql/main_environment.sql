...
CREATE TABLE `environment` (
  ...
  `Stdin` varchar(100) DEFAULT NULL,
  `Code` mediumblob,
  `PlaygroundID` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`Language`,`PlaygroundID`),
  KEY `PlaygroundID` (`PlaygroundID`),
  CONSTRAINT `environment_ibfk_1` FOREIGN KEY (`PlaygroundID`) REFERENCES `playground` (`PlaygroundID`)
...
INSERT INTO `environment` VALUES ('Java','','',2729),('Java','','',2948),('Java','','',3253),('C','','',2390),('C','','',2409),('C','','',3268),('C++','','',2323),('C++','','',2439),('Python','','',2473),('Python','','',3037);
